...
namespace dcclite::broker::exec::dcc
{
	...
	namespace detail
	{
		...
		{
			public:
				Location(RName name, RName prefix, const Address beginAddress, const Address endAddress, LocationManager &owner);
				...
				inline Address GetBeginAddress() const
				{
					return m_tBeginAddress;
				}

				inline Address GetEndAddress() const
				{
			...
			private:
				RName		m_rnPrefix;
				Address	m_tBeginAddress;
				Address	m_tEndAddress;
