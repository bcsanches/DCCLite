...
{
    public partial class RemoveInfoServiceUserControl : UserControl
    {
        public RemoveInfoServiceUserControl()
        {
            InitializeComponent();
        }

        public RemoveInfoServiceUserControl(String name, int beginAddress, int endAddress, RemoteDecoder[] decoders) :
            this()
        {
